...
# from doom_agent.algorithms.dreamer.v3.doom_envs import DoomEnv # Unused import removed
...
DEATHMATCH_CURRICULUM = Curriculum(
    ...
    stages=[
        ...
        Stage(
            ...
            timesteps=1_000_000,
            doom_skill=3,
            living_reward=-0.01, # Hambre inicial
            frame_skip=4,
        ...
        Stage(
            ...
            timesteps=2_000_000,
            doom_skill=4,
            living_reward=-0.02, # Mayor presión
            frame_skip=4,
        ...
        Stage(
            ...
            timesteps=4_000_000,
            doom_skill=5,
            living_reward=-0.05, # Máxima agresividad requerida
            frame_skip=4,
