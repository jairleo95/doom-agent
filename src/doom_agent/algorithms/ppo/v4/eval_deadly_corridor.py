...
Uso:
    PYTHONPATH=src python -m doom_agent.algorithms.ppo.v4.eval_deadly_corridor --model checkpoints/deadly_corridor/ppo_v4_best.zip
"""
import argparse
...
from doom_agent.algorithms.ppo.v4.envs import DoomCorridorEnv, deadly_corridor_actions
