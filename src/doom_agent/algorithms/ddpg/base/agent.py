...
from doom_agent.algorithms.dqn.dddqn.dueling_dqn_network import DQNModel
from doom_agent.algorithms.dqn.dddqn.memory import Memory
from doom_agent.utils.utils import plotLearning
class Agent(object):
    def __init__(self,
                 lr,
                 gamma,
        ...
        self.results_filename = 'results/' + str(total_episodes) + 'Games' + 'Gamma' + str(gamma) + 'Alpha' + str(
            lr) + 'Memory' + str(mem_size) + '_vizdoom_ddpg_tf2.png'
    ...
    def train(self):
        ...
        for episode in range(total_episodes):
            ...
            print('Episode: {}/{}, Total reward: {}, e: {:.2}, average: {} {}'.format(episode, total_episodes,
                                                                                      total_reward,
                                                                                      agent.epsilon, eps_reward,
                                                                                      "SAVING"))
