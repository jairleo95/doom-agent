...
from doom_agent.algorithms.dddqn_tf2.config import *
from doom_agent.algorithms.dddqn_tf2.dddqn_agent import Agent
from doom_agent.algorithms.dddqn_tf2.doom_wrapper import *
...
game.load_config(scenario_path("basic.cfg"))

# Load the correct scenario (in our case deadly_corridor scenario)
game.set_doom_scenario_path(scenario_path("basic.wad"))
