...
from doom_agent.algorithms.a2c_defend_the_center.agent import A2CAgent
from doom_agent.algorithms.a2c_defend_the_center.networks import Networks
...
if __name__ == "__main__":
    ...
    game = DoomGame()
    game.load_config(scenario_path("defend_the_center.cfg"))
