...
from doom_agent.algorithms.dqn.v1_tf2.simple_dqn_tf2 import Agent
...
class DoomEnv():
    def __init__(self):
        ...
        self.game.load_config(scenario_path("basic.cfg"))
        self.game.set_doom_scenario_path(scenario_path("basic.wad"))
        self.game.init()
