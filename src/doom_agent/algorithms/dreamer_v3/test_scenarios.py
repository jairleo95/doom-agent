...
# Add src to path
# Assuming this script is in src/doom_agent/algorithms/dreamer_v3/
sys.path.append(str(Path(__file__).resolve().parents[4] / "src"))
# Local import fix
sys.path.append(str(Path(__file__).resolve().parent))

from doom_agent.algorithms.dreamer_v3.train import main as train_main
...
class TestScenarios(unittest.TestCase):
    ...
    def run_scenario(self, scenario_name):
        ...
        with patch.object(sys, 'argv', args):
            ...
            from doom_agent.algorithms.dreamer_v3 import train
            from doom_agent.algorithms.dreamer_v3.curriculum import Stage, Curriculum
