...
from doom_agent.algorithms.dreamer_v3.callbacks import MetricsCallback, ImaginationVideoCallback
from doom_agent.algorithms.dreamer_v3.train import flip_actions
...
class TestAdvancedFeatures(unittest.TestCase):
    ...
    def test_metrics_callback_detailed(self):
        ...
        patch_target = 'doom_agent.algorithms.dreamer_v3.callbacks.SummaryWriter'
