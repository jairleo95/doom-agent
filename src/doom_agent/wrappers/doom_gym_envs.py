...
from doom_agent.common.models import init_model
from doom_agent.common.monitoring import LayerActivationMonitoring
from doom_agent.common.utils import get_available_actions
...
def create_env(scenario: str, **kwargs) -> DoomEnv:
    ...
    game = vizdoom.DoomGame()
    game.load_config(scenario_path(f"{scenario}.cfg"))
    game.init()
