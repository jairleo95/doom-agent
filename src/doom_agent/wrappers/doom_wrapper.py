...
class DoomEnv():
    def __init__(self, stack_size, img_shape,
        ...
        self.scenario = scenario_path(scenario) if not Path(scenario).is_absolute() else scenario
    ...
    def create_env(self):
        ...
        # self.game.set_doom_scenario_path(scenario_path("defend_the_center.wad"))
...
if __name__ == '__main__':
    env = DoomEnv(stack_size=4,
                  ...
                  scenario=scenario_path("deadly_corridor.cfg"),
