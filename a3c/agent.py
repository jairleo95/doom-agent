...
import cv2
import numpy as np
from a3c.model import A3CModel
import os
...
class A3CAgent:
    ...
    def __init__(self, env_name, env, state_size):
        # Initialization
        # Environment and PPO parameters
        self.env_name = env_name
        self.env = env

        self.action_size = self.env.get_num_actions()
        self.EPISODES, self.episode, self.max_average = 4000, 0, 0.0
        self.lock = Lock()
        self.lr = 0.000025
    ...
    def train(self, n_threads):
        ...
        envs = [self.env.create_env() for i in range(n_threads)]
