...
PPO_EPOCHS = 4
MINI_BATCH_SIZE = 256
CHECKPOINT_DIR = "checkpoints/deadly_corridor"
...
def train_ppo_deadly_corridor():
    ...
    writer = SummaryWriter(log_dir="runs/vizdoom_ppo_deadly_corridor")
    ...
    for update in range(1, NUM_UPDATES + 1):
        ...
        if update % CHECKPOINT_INTERVAL == 0:
            periodic_path = os.path.join(CHECKPOINT_DIR, PERIODIC_MODEL_TEMPLATE.format(update))
